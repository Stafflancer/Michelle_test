...
/**
 * Provides a resource to update article.
 *
 * @RestResource(
 *   id = "update_article_resource",
 *   label = @Translation("Update article resource"),
 *   uri_paths = {
 *     "create" = "/api/v1/update-article",
 *   }
 * )
 */
class UpdateArticleResource extends ResourceBase {
